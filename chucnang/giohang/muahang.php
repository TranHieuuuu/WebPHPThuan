...
// Danh sách Sản phẩm đã mua
    ...
    <b><br />Cám ơn Quý khách đã sử dụng Sản phẩm của Công ty chúng Tôi!</b>
        ...
        // Phải chỉnh sửa lại
        $mailer->Username = "tranvanhieu_t62@hus.edu.vn"; // GMAIL username
        $mailer->Password = "17000131"; // GMAIL password
        $mailer->AddAddress($email, $ten); //email người nhận
        $mailer->AddCC("tranvanhieu_t62@hus.edu.vn", "17000131"); // gửi thêm một email cho Admin
        // Chuẩn bị gửi thư nào
        $mailer->FromName = 'Điện tử Đức Tuấn'; // tên người gửi
        $mailer->From = 'tranvanhieu_t62@hus.edu.vn'; // mail người gửi
        $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ Điện tử Đức Tuấn';
